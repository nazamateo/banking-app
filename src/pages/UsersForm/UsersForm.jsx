...
import accountNumCount from "../../components/General/Helpers/AccountNumberCreator";
...
const addUserdata = (e)=>{
    ...
    getFromLocalStorage = localStorage.setItem("userdetails", JSON.stringify(getFromLocalStorage))
...
<form className="form" onSubmit={addUserdata}>
    ...
    <div className="divdate"> 
        ...
        <input type="text" className="form-fields" id="creationDate" value={creationDate} disabled
        onChange={(e) => setcreationDate(e.target.value)}/>
    </div>

    <div className="acct"> 
        <label for="accountNumber" className="form-label">Account Number</label>
        <input type="text" className="form-fields" id="accountNumber" value={accountNumCount} disabled

...
const userArr  = [{
    ...
    Age: '45',
    Address: '#170 EDAP Building Cenetr, Boni Serrano Road, Camp Aguinaldo,Quezon City,Philippines',
    ...
    Age: '43',
    Address: 'Onyxson Building 2066 Onyx St. Fabie Estate, Paco, Manila,Manila,Philippines',
    ...
    Age: '34',
    Address: '43 Clarinda Soriano Street, B F Resort Village,Las Pinas,Philippines',
    ...
    Age: '49',
    Address: 'SM Mall of Asia, SM Central Business Park, Bay City,Pasay City,Philippines',
    ...
    Age: '59',
    Address: 'Suite 101, M/F Eastgate Center Building, 169 EDSA,Mandaluyong City,Philippines',
  ...
  const Header = () => {
  return <tr><th>Name</th><th>Email</th><th>Age</th><th>Address</th><th>Creation Date</th><th>Account Number</th></tr>
  }
  
  const Rows = ({userInfo}) => {
  return userInfo.map((props) =>
    <tr>
      <td>{props.Name}</td><td>{props.Email}</td><td>{props.Age}</td><td>{props.Address}</td><td>{props.Creationdate}</td><td>{props.Accountnumber}</td>
    </tr>
  )
  }
